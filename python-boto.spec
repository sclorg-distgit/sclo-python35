# centos/sclo spec file for python-boto, from:
#
# Fedora spec file
#
...
%if %{with unittests}
BuildRequires:  %{?scl_prefix}python-httpretty
...
%if 0%{?scl:1}
Provides: %{?scl_prefix}python-boto = %{version}-%{release}
%if %{?with_python3}
Provides: %{?scl_prefix}python3-boto = %{version}-%{release}
%else
Provides: %{?scl_prefix}python2-boto = %{version}-%{release}
%endif
%endif

Requires:       %{?scl_prefix}python-requests
Requires:       %{?scl_prefix}python-rsa
Requires:       %{?scl_prefix}python-six >= 1.7
